...
const StudentMyPage = (props:any) => {
    ...
    const onClickUpdate = () => {
        console.log("클릭함");
        if( !name.value || !organization.value || !password.value || !classroom.value || !grade.value || !tag.value ) {
            alert("모두다 입력하세요");
        }
        let body = {
            pk:email,
                ...
                <Wrapper>
                    ...
                    <Main>
                        ...
                        <WrapDIV>
                            ...
                            <InputTag 
                                type="number"
                                placeholder={data?.grade ? data?.grade : "없다"}
                                {...grade}    
                            />
                            <Ptext>반</Ptext>
                            <InputTag 
                                type="number"
                                placeholder={data?.classroom ? data?.classroom : "없다"}
                                {...classroom}    
                            />
                            <Ptext>번</Ptext>
                            <InputTag 
                                type="number"
                                placeholder={data?.tag ? data?.tag : "없다"}
                                {...tag}    
                            />
                        </WrapDIV>
                        <WrapDIV>
